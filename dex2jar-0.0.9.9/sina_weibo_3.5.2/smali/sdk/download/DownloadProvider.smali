.class public final Lsdk/download/DownloadProvider;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lsdk/download/DownloadProvider;->a:Ljava/lang/String;
    ...
    sput-object v1, Lsdk/download/DownloadProvider;->b:Landroid/content/UriMatcher;
    ...
    sput-object v1, Lsdk/download/DownloadProvider;->c:[Ljava/lang/String;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    sput-object v1, Lsdk/download/DownloadProvider;->d:Ljava/util/HashSet;

    :goto_0
    sget-object v1, Lsdk/download/DownloadProvider;->c:[Ljava/lang/String;

    array-length v1, v1

    if-ge v0, v1, :cond_0

    sget-object v1, Lsdk/download/DownloadProvider;->d:Ljava/util/HashSet;

    sget-object v2, Lsdk/download/DownloadProvider;->c:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lsdk/download/DownloadProvider;->e:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method static synthetic a()Ljava/lang/String;
    ...
    sget-object v0, Lsdk/download/DownloadProvider;->a:Ljava/lang/String;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    sget-object v0, Lsdk/download/DownloadProvider;->d:Ljava/util/HashSet;

    invoke-static {p2, v0}, Lsdk/download/l;->a(Ljava/lang/String;Ljava/util/Set;)V

    iget-object v0, p0, Lsdk/download/DownloadProvider;->e:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    sget-object v2, Lsdk/download/DownloadProvider;->b:Landroid/content/UriMatcher;
    ...
    const-class v5, Lsdk/download/DownloadService;
    ...
    const-class v2, Lsdk/download/DownloadService;
    ...
    const-string v2, "task inserted, url = "
...
.method public onCreate()Z
    ...
    invoke-direct {v0, p0, v1}, Lsdk/download/e;-><init>(Lsdk/download/DownloadProvider;Landroid/content/Context;)V
...
.method public openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual/range {v0 .. v5}, Lsdk/download/DownloadProvider;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_4
    invoke-static {v0}, Lsdk/download/l;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v1, v3, v3}, Lsdk/download/DownloadProvider;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {p3, v0}, Lsdk/download/l;->a(Ljava/lang/String;Ljava/util/Set;)V
    ...
    sget-object v4, Lsdk/download/DownloadProvider;->b:Landroid/content/UriMatcher;
    ...
    sget-object p2, Lsdk/download/DownloadProvider;->c:[Ljava/lang/String;
    ...
    new-instance v0, Lsdk/download/f;

    invoke-direct {v0, p0, v1}, Lsdk/download/f;-><init>(Lsdk/download/DownloadProvider;Landroid/database/Cursor;)V
    ...
    sget-object v6, Lsdk/download/DownloadProvider;->d:Ljava/util/HashSet;
